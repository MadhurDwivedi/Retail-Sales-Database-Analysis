/* Business Transformations, Queries, Key Q & A */

-- 1- Write a SQL Query to retrieve all cloumns for sales made on '2022-11-05'?

SELECT * FROM retail_sales 
WHERE sale_date = '2022-05-22';

-- 2- Write a SQL Query to retrieve all transactions where the category is 'Clothing' and the quantitysold is more than 4 in the month of Nov-2022?
...
SELECT ROUND(AVG(age), 2) as avg_ageage FROM retail_sales
